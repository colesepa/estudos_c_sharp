...
/*
(<tipo>) CAST:
    Definição de tipo que pode converter tipos similares (decimal -> int..). Não funciona pra conversão de tipos não 
    compatíveis (string -> int).

Para conversão de tipos, podemos invocar a classe Convert e escolher qual método de adequa as nossas necessidades.
*/

// StudentsGrades sg = new();

// sg.Test();


// var sg2 = new StudentsGrades();
// sg2.Test();

var matheus = new Student
{
    Name = "Matheus",
    Age = 23
};
